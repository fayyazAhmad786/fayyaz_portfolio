  ...
  Widget build(BuildContext context) {
    return const Column(
      ...
      children: [
        ...
        AnimatedLinearProgressIndicator(percentage: 0.9, title: 'Android',image: 'assets/icons/flutter.png',),
        AnimatedLinearProgressIndicator(percentage: 0.7, title: 'Dart',image: 'assets/icons/dart.png'),
        AnimatedLinearProgressIndicator(percentage: 0.9, title: 'Kotlin',image: 'assets/icons/dart.png'),
        AnimatedLinearProgressIndicator(percentage: 0.9, title: 'Java',image: 'assets/icons/dart.png'),
